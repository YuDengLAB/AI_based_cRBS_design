...
MAX_N_EXAMPLES = 7053 # Max number of data examples to load. If data loading
...
#gen_train_op = tf.train.AdagradOptimizer(learning_rate=1e-4, initial_accumulator_value=0.1, use_locking=False).minimize(gen_cost, var_list=gen_params)
#disc_train_op = tf.train.AdagradOptimizer(learning_rate=1e-4, initial_accumulator_value=0.1, use_locking=False).minimize(disc_cost, var_list=disc_params)
gen_train_op = tf.train.RMSPropOptimizer(learning_rate=1e-4, decay=0.9, momentum=0.0, epsilon=1e-10, use_locking=False,centered=False, name='RMSProp').minimize(gen_cost, var_list=gen_params)
disc_train_op = tf.train.RMSPropOptimizer(learning_rate=1e-4, decay=0.9, momentum=0.0, epsilon=1e-10, use_locking=False,centered=False, name='RMSProp').minimize(disc_cost, var_list=disc_params)

#tf.train.RMSPropOptimizer(learning_rate=1e-4, decay=0.9, momentum=0.0, epsilon=1e-10, use_locking=False,centered=False, name='RMSProp')
